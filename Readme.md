...
## Тема: Структури даних: стек та черга

## Опис
Це гілка для виконання лабораторної роботи #4 з курсу
...
1. Вивчити теоретичний матеріал з теми: **Структури даних: стек та черга**
